...
def _handle_ai_search(payload: AISearchRequest) -> dict:
    try:
...
def ai_search(payload: AISearchRequest) -> dict:
    return _handle_ai_search(payload)


@router.post("/research", response_model=AISearchResponse)
def research(payload: AISearchRequest) -> dict:
    return _handle_ai_search(payload)
